...
<head>
    ...
    <title>Application sunuligueye</title>
...
<body class="login-container">
     <button class="btn bg-teal" style="float: right;right: 6px;top:4px;"><a href="{{url('/')}}" style="color:white;">Retour à l'accueil</a></button>
